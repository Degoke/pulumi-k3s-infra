...
require (
	github.com/Degoke/pulumi-k3s v0.0.0-20220906083102-29e2100fd818 // indirect
	...
	github.com/pulumi/pulumi-kubernetes/sdk/v4 v4.3.0 // indirect
